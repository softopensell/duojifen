...
public class GoodsEntity implements Serializable {
    ...
    private String goodSizeTag;
    private String goodColorTag;
    private String goodOtherTag;
	...
	public String getGoodSizeTag() {
		return goodSizeTag;
	}

	public void setGoodSizeTag(String goodSizeTag) {
		this.goodSizeTag = goodSizeTag;
	}

	public String getGoodColorTag() {
		return goodColorTag;
	}

	public void setGoodColorTag(String goodColorTag) {
		this.goodColorTag = goodColorTag;
	}

	public String getGoodOtherTag() {
		return goodOtherTag;
	}

	public void setGoodOtherTag(String goodOtherTag) {
		this.goodOtherTag = goodOtherTag;
	}
