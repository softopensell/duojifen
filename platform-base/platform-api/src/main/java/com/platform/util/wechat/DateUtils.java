...
public class DateUtils {
	...
	public static String formatTodayTime() {
		java.util.Date pdate = new Date();
		return formatDate(pdate, "yyMMddHHmmss");
	}
	...
	public static void main(String args[]) throws ParseException {
		System.out.println(getPastDate("","yyyy-MM-dd"));

		System.out.println(formatCurrrentDates());
		System.out.println(DateUtils.formatYYMMDDHHMM(DateUtils.getDateBetweenHour(new Date(), 1)));
		System.out.println(DateUtils.formatYYMMDDHHMM(DateUtils.getDateBetweenHour(new Date(), -1)));

		System.out.println(isValid("为而为", "yyyyMMdd"));
		String content = "2013年05月22日";
		content = content.replace("年", "-");
		content = content.replace("月", "-");
		content = content.replace("日", "");
		Date startDate = DateUtils.parseDateYYMMddHHmm("2015-05-13 16:21");
		System.out.println(DateUtils.formatYYMMDDHHMM(startDate));
		Date date = new Date();// DateUtils.parseDateYYMMddHHmm("2015-01-05
								// 12:20");

		String strDate = "2017年39周";

		System.out.println(DateUtils.formatDate(date, "yyy-MM"));
		System.out.println(DateUtils.format(DateUtils.parseDate(strDate, "yyyy年W周"), "yyyy-MM-dd HH:mm"));
		System.out.println(DateUtils.format(DateUtils.getFirstDayOfWeek(DateUtils.parseDate(strDate, "yyyy年W周")),
				"yyyy-MM-dd HH:mm"));
		System.out.println(DateUtils.format(DateUtils.getLastDayOfWeek(DateUtils.parseDate(strDate, "yyyy年W周")),
				"yyyy-MM-dd HH:mm"));

		System.out.println("------");
		// System.out.println(DateUtils.format(DateUtils.getFirstDayOfWeek(date),
		// "yyyy-MM-dd HH:mm"));
		// System.out.println(DateUtils.format(DateUtils.getLastDayOfWeek(date),
		// "yyyy-MM-dd HH:mm"));
		// System.out.println(DateUtils.format(DateUtils.getMonthFirstDayOfDate(date),
		// "yyyy-MM-dd HH:mm"));
		// System.out.println(DateUtils.format(DateUtils.getMonthLastDayOfDate(date),
		// "yyyy-MM-dd HH:mm"));
		// System.out.println(DateUtils.format(DateUtils.getYearFirstDayOfDate(date),
		// "yyyy-MM-dd HH:mm"));
		// System.out.println(DateUtils.format(DateUtils.getYearLastDayOfDate(date),
		// "yyyy-MM-dd HH:mm"));
		//

		System.out.println(DateUtils.getWeekSumOfYearByDay(date));
		System.out.println(DateUtils.format(DateUtils.getStartOfDate(new Date()), "yyyy-MM-dd HH:mm"));

		String statTypeShowFormat = "yyyy年W周";
		Date tempDate = DateUtils.parseWeekDate(strDate, statTypeShowFormat);
		System.out.println(DateUtils.format(tempDate, "yyyy-MM-dd HH:mm"));

		System.out.println(DateUtils.format(DateUtils.getFirstDayOfWeek(tempDate), "yyyy-MM-dd HH:mm"));
		System.out.println(DateUtils.format(DateUtils.getLastDayOfWeek(tempDate), "yyyy-MM-dd HH:mm"));

		java.util.Calendar currentDate = new GregorianCalendar();
		currentDate.setTime(tempDate);
		...
		System.out.println(DateUtils.format(dBegin, "yyyy-MM-dd HH:mm"));
		System.out.println(DateUtils.format(dEnd, "yyyy-MM-dd HH:mm"));

		// System.out.println(DateUtils.str_ToDate(content));
		// Date date=DateUtils.str_ToDate(content);
		...
		// System.out.println(date);
		//
		// System.out.println(DateUtils.format2(date));
		//
		// Timestamp createTime=new Timestamp(System.currentTimeMillis());
		// System.out.println(DateUtils.format2(createTime));
		// System.out.println(DateUtils.getHourSpan(DateUtils.getTodayDay(),
		// DateUtils.getNextDay()));
		// System.out.println(DateUtils.getHourSpan(DateUtils.getTodayDay(),
		// DateUtils.getPreviousDay(DateUtils.getTodayDay())));
	}
