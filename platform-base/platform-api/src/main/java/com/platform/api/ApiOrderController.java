...
public class ApiOrderController extends ApiBaseAction {
	...
	@FrequencyLimit(count=1,time=10,action="immediateBuy",forbiddenTime=60*1)
	@SingleLock
	public Object immediateBuy(@LoginUser UserVo loginUser) {
		...
		try {
			...
			String goodTags = jsonParams.getString("goodTags");
			...
			resultObj = goodsOrderService.toSubmitImmediateBuyGoodOrder(userEntity, goodId,sum, orderPayType,goodTags);
