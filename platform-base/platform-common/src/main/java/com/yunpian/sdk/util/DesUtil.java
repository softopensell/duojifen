...
public class DesUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //        String tmp = encryptForYunpian("Yunpian", "12345678123456781234567812345678");
        //        System.out.println(tmp);
        //        System.out.println(decryptForYunpian(tmp, "12345678123456781234567812345678"));
        System.out.println(
            decryptForYunpian("RLlJ+bgSQnRRguZMMPqQWPu7QmWwrxdSbgEIRSxtZD4X7RBRmdIllQ==",
                "12345678"));
        /*
         * 使用CBC mode
         * 使用密钥工厂生成密钥，加密 解密
        ...
        byte[] enc = cipher.doFinal(
            "https://mail.google.com/mail/u/0/#inbox/a1ed0e2f6f28e06b4361".getBytes()); //加密
