...
import com.alipay.api.response.AlipayOpenPublicLifeAboardApplyResponse;
...
public class AlipayOpenPublicLifeAboardApplyRequest implements AlipayRequest<AlipayOpenPublicLifeAboardApplyResponse> {
	...
	public Class<AlipayOpenPublicLifeAboardApplyResponse> getResponseClass() {
		return AlipayOpenPublicLifeAboardApplyResponse.class;
	}
