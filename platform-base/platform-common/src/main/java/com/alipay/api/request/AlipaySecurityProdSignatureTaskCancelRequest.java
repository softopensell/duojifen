...
import com.alipay.api.response.AlipaySecurityProdSignatureTaskCancelResponse;
...
public class AlipaySecurityProdSignatureTaskCancelRequest implements AlipayRequest<AlipaySecurityProdSignatureTaskCancelResponse> {
	...
	* 支付宝可信电子签名任务撤销
	...
	public Class<AlipaySecurityProdSignatureTaskCancelResponse> getResponseClass() {
		return AlipaySecurityProdSignatureTaskCancelResponse.class;
	}
