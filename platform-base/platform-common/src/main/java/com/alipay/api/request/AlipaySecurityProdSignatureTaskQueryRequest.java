...
import com.alipay.api.response.AlipaySecurityProdSignatureTaskQueryResponse;
...
public class AlipaySecurityProdSignatureTaskQueryRequest implements AlipayRequest<AlipaySecurityProdSignatureTaskQueryResponse> {
	...
	* 支付宝可信电子签名结果查询
	...
	public Class<AlipaySecurityProdSignatureTaskQueryResponse> getResponseClass() {
		return AlipaySecurityProdSignatureTaskQueryResponse.class;
	}
