...
import com.alipay.api.response.KoubeiMarketingDataEnterpriseStaffinfoUploadResponse;
...
public class KoubeiMarketingDataEnterpriseStaffinfoUploadRequest implements AlipayRequest<KoubeiMarketingDataEnterpriseStaffinfoUploadResponse> {
	...
	* 外部企业员工信息上传接口
	...
	public Class<KoubeiMarketingDataEnterpriseStaffinfoUploadResponse> getResponseClass() {
		return KoubeiMarketingDataEnterpriseStaffinfoUploadResponse.class;
	}
