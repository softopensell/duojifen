...
//	public static final String SEED = "g8GjEvTbW5oVSV7avL47357438reyhreyuryetredLDVKs2m0QN7vxRs2im5MDaNCWGmcD2rvcZx";
	...
	public long get_code(String secret,long timeMsec) {
		Base32 codec = new Base32();
		byte[] decodedKey = codec.decode(secret);
		// convert unix msec time into a 30 second "window"
		// this is per the TOTP spec (see the RFC for details)
...
//		  String qrcode = GoogleAuthenticator.getQRBarcode("555555@qq.com", secret); 
//		  System.out.println("qrcode:" + qrcode + ",key:" + secret); 
//		 String secret="ZMM6ESF74CZ36NAJ";
		 GoogleAuthenticator ga = new GoogleAuthenticator(); 
		 long timeMsec = System.currentTimeMillis(); 
		 long code = ga.get_code(secret, timeMsec);
		 System.out.println("code=======" + code); 
		 ga.setWindowSize(5); 
		 boolean r = ga.check_code(secret, code, timeMsec); 
