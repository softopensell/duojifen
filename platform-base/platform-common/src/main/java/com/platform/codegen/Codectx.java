...
public final class Codectx {
	...
	public static final int DEFAULT_CODE_WIDTH = 350;

	public static final int DEFAULT_CODE_HEIGHT = 350;
	...
	public static final String DEFAULT_LOGO_BORDER_COLOR = "#00b38a";//#808080
