...
public class QreyesPosition implements Serializable {
	...
	public QreyesPosition focusPoint(int imgWidth, int imgHeight) {
		...
		int _bottomStartY = imgHeight - topLeftOnBit[1] - h * QreyesRenderStrategy.POINT.getEnd();
		int _bottomEndY = imgHeight - topLeftOnBit[1] - h * QreyesRenderStrategy.POINT.getStart();
