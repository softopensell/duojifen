...
public class LogoConfig implements Serializable {
	...
	private boolean backgroundColorIsTransparent =false;
	...
	/**
	 * @return the backgroundColorIsTransparent
	 */
	public boolean isBackgroundColorIsTransparent() {
		return backgroundColorIsTransparent;
	}

	/**
	 * @param backgroundColorIsTransparent the backgroundColorIsTransparent to set
	 */
	public void setBackgroundColorIsTransparent(boolean backgroundColorIsTransparent) {
		this.backgroundColorIsTransparent = backgroundColorIsTransparent;
	}
