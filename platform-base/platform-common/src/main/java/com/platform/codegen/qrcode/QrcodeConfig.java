...
import com.platform.codegen.Codectx.BorderStyle;
import com.platform.codegen.GenericCodeConfig;
...
public class QrcodeConfig extends GenericCodeConfig {
	...
	@Override
	public QrcodeConfig setBackgroundImage(String backgroundImage) {
	...
	public QrcodeConfig setLogoBackgroundColorIsTransparent(boolean backgroundColorIsTransparent) {
		getLogoConfig().setBackgroundColorIsTransparent(backgroundColorIsTransparent);
		return this;
	}
