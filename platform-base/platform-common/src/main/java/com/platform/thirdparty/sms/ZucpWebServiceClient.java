...
* @Title: ZucpWebServiceClient.java 
* @Package com.taotaoti.plugin.sms 
* @Description:webservice服务器定义 
* @author  softopensell
* @email softopensell@91jiaoke.com  
* @date 2015年3月20日 下午3:23:09 
* @version V1.0   
*/
public class ZucpWebServiceClient {
	 ...
	 * 构造函数
	 */
	public ZucpWebServiceClient(String sn, String password)
