...
public class SysOssServiceImpl implements SysOssService {
    ...
    @Override
    public  SysOssEntity queryByUrl(String url) {
    	return sysOssDao.queryByUrl(url);
    }
    @Override
    public List<SysOssEntity> queryByFromTypeAndFromNo(Integer ossFormType,String ossFormNo){
    	return sysOssDao.queryByFromTypeAndFromNo(ossFormType, ossFormNo);
    }
