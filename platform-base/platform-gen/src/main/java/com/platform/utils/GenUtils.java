...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("template/ApiEntity.java.vm");
        templates.add("template/ApiDao.java.vm");
        templates.add("template/ApiDao.xml.vm");
        templates.add("template/ApiService.java.vm");
    ...
    public static String getFileName(String template, String className, String packageName) {
        ...
        //---------------------add by softopensell in 20190322-- for api---begain---------------------
        if (template.contains("ApiEntity.java.vm")) {
            return packagePath + "api" + File.separator + "entity" + File.separator + className + "Vo.java";
        }

        if (template.contains("ApiDao.java.vm")) {
            return packagePath+ "api" + File.separator + "dao" + File.separator +"Api"+ className + "Mapper.java";
        }

        if (template.contains("ApiDao.xml.vm")) {
            return packagePath + "api" + File.separator+ "dao" + File.separator +"Api"+ className + "Mapper.xml";
        }

        if (template.contains("ApiService.java.vm")) {
            return packagePath + "api" + File.separator+ "service" + File.separator + "Api"+className + "Service.java";
        }
       
        if (template.contains("ApiController.java.vm")) {
            return packagePath + "api" + File.separator +"Api"+ className + "Controller.java";
        }
        //---------------------add by softopensell in 20190322-- for api---end---------------------
